...
Begin VB.Form FrmEditDetailFalle 
   BorderStyle     =   0  'None
   Caption         =   "Form1"
   ClientHeight    =   9060
   ClientLeft      =   0
   ...
   Begin HaftAlmas.TypeButton CmdClose 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmEditDetailFalle.frx":0000
      PICN            =   "FrmEditDetailFalle.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin HaftAlmas.TypeButton CmdEditDetail 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmEditDetailFalle.frx":3A8A
      PICN            =   "FrmEditDetailFalle.frx":3AA6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin HaftAlmas.TypeButton CmdFind 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmEditDetailFalle.frx":71EA
      PICN            =   "FrmEditDetailFalle.frx":7206
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin HaftAlmas.TypeButton CmdEditMain 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmEditDetailFalle.frx":AB05
      PICN            =   "FrmEditDetailFalle.frx":AB21
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin HaftAlmas.TypeButton CmdShowDetail 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmEditDetailFalle.frx":E4A8
      PICN            =   "FrmEditDetailFalle.frx":E4C4
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin HaftAlmas.TypeButton CmdFindDetail 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmEditDetailFalle.frx":12086
      PICN            =   "FrmEditDetailFalle.frx":120A2
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin HaftAlmas.TypeButton CmdDeleteDetail 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmEditDetailFalle.frx":159A1
      PICN            =   "FrmEditDetailFalle.frx":159BD
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Label LblAlarm 
      Alignment       =   1  'Right Justify
      BackStyle       =   0  'Transparent
      Caption         =   $"FrmEditDetailFalle.frx":195BD
      ForeColor       =   &H00FF0000&
      Height          =   1125
      Left            =   3480
      MouseIcon       =   "FrmEditDetailFalle.frx":19657
      RightToLeft     =   -1  'True
      TabIndex        =   14
      Top             =   7440
      Width           =   7170
   ...
   Begin VB.Label Label1 
      ...
      Height          =   405
      Left            =   6315
      MouseIcon       =   "FrmEditDetailFalle.frx":19961
      RightToLeft     =   -1  'True
      TabIndex        =   4
      Top             =   840
      Width           =   3360
   ...
   End
End
Attribute VB_Name = "FrmEditDetailFalle"
...
Private Sub CmdDeleteDetail_Click()
 ...
 If r > 0 Then
    ...
    If msg = vbYes Then
       ...
       strSql = "DELETE FROM DetailFalle "
...
Private Sub CmdEditDetail_Click()
 ...
 If CmdEditDetail.Caption = "ÊÌ—«Ì‘ «ÿ·«⁄«  Ã«‰»Ì" Then
    ...
    If r > 0 Then
       ...
       For i = 1 To Grid1.Rows - 1
          If i <> r Then
             Grid1.Range(i, 1, i, 13).Locked = True
          Else
             Grid1.Range(i, 1, i, 13).Locked = False
          End If
       Next
       Grid1.Range(r, 1, r, 13).BackColor = QBColor(11)
       Grid1.Cell(r, 13).Locked = True
...
Private Sub CmdShowDetail_Click()
 ...
 '
 strSql = "SELECT * FROM DetailFalle "
 strSql = strSql & "WHERE Code=" & CodePaEt
 rs.Open strSql, CNS
 If rs.EOF Then
 ...
 Else
    ...
    Do While Not rs.EOF
       ...
       With Grid1
            ...
            .Cell(r, 4).Text = IIf(IsNull(rs("Vazn")), "", rs("Vazn"))
            .Cell(r, 5).Text = IIf(IsNull(rs("ShomareMashin")), "", rs("ShomareMashin"))
            .Cell(r, 6).Text = IIf(IsNull(rs("DriverName")), "", rs("DriverName"))
            .Cell(r, 7).Text = IIf(IsNull(rs("Parvande")), "", rs("Parvande"))
            .Cell(r, 8).Text = IIf(IsNull(rs("Address")), "", rs("Address"))
            .Cell(r, 9).Text = IIf(IsNull(rs("Tarikh")), "", rs("Tarikh"))
            .Cell(r, 10).Text = IIf(IsNull(rs("BarName")), "", rs("BarName"))
            .Cell(r, 11).Text = rs("Part")
            .Cell(r, 12).Text = rs("Count0")
            .Cell(r, 13).Text = r
...
Private Sub CmdEditMain_Click()
 ...
 ElseIf CmdEditMain.Caption = "À»   €ÌÌ—« " Then
    ...
    strSql = "UPDATE MainFalle SET "
    strSql = strSql & "Etebar='" & TxtEtebar & "',Part='" & TxtPart
    strSql = strSql & "',Weight=" & Val(TxtWeight)
    strSql = strSql & ",MoshtariCode=" & Val(CombMoshtariCode)
    strSql = strSql & ",KeshtiName='" & TxtKeshtiName & "' "
    strSql = strSql & " WHERE Code=" & CodePaEt
    rs.Open strSql, CNS
...
Private Sub SetGrid()
 ...
 With Grid1
      ...
      .Column(10).Width = 100
      .Column(11).Width = 100
      .Column(12).Width = 0 ' Hidden For Count0
      .Column(13).Width = 40
      ...
      .Cell(0, 10).Text = "‘„«—Â »«—‰«„Â"
      .Cell(0, 11).Text = "Å«— "
      .Cell(0, 12).Text = "—œÌ›0" ' Count0 ast Code nemikham hamoon CODEPaEt
      .Cell(0, 13).Text = "—œÌ›"  ' Radife Jadval
      '
      .ReadOnly = True
...
Private Function SubMakeQuery(r As Long) As String
 ...
 With Grid1
   strSql = "UPDATE DetailFalle SET "
   strSql = strSql & "Part='" & .Cell(r, 11).Text & "'"
   strSql = strSql & ",BarNamE=" & Val(.Cell(r, 10).Text)
   strSql = strSql & ",Tarikh='" & .Cell(r, 9).Text & "'"
   strSql = strSql & ",Address='" & .Cell(r, 8).Text & "'"
   strSql = strSql & ",Parvande='" & .Cell(r, 7).Text & "' "
   strSql = strSql & ",DriverName='" & .Cell(r, 6).Text & "' "
   strSql = strSql & ",ShomareMashin='" & .Cell(r, 5).Text & "'"
   strSql = strSql & ",Vazn=" & Val(.Cell(r, 4).Text)
   strSql = strSql & ",PayeKeraye=" & Val(.Cell(r, 3).Text)
   strSql = strSql & ",Keraye=" & Val(.Cell(r, 2).Text)
   strSql = strSql & ",Mobile='" & .Cell(r, 1).Text & "' "
   
   strSql = strSql & "WHERE Code=" & CodePaEt
   strSql = strSql & " AND Count0=" & Val(.Cell(r, 12).Text)
...
Private Sub UpdateBaghimandeTable(r As Long)
 ...
 With Grid1
   strSql = "SELECT SUM(Vazn) FROM DetailFalle "
   strSql = strSql & "WHERE Code=" & CodePaEt
   strSql = strSql & " AND Tarikh='" & .Cell(r, 9).Text & "'"
   rs.Open strSql, CNS
   sumVazn = IIf(IsNull(rs(0)), 0, rs(0))
   rs.Close
   ''
   strSql = "SELECT Count0 FROM BaghimandeFalle "
   strSql = strSql & "WHERE Code=" & CodePaEt
   strSql = strSql & " AND Tarikh='" & .Cell(r, 9).Text & "'"
   rs.Open strSql, CNS
   PrevCount0 = rs(0) - 1
   ...
   If PrevCount0 = 0 Then ' yani taghir bar roye avalin satr anjam mishavad
      ...
      Do While Not rs.EOF
         ...
         rs("BaghiVazn") = BaghiVazn - TempRS(0)
         rs.Update
         TempRS.Close
      Loop
      rs.Close
   Else
      ''
      strSql = "SELECT BaghiVazn FROM BaghimandeFalle "
      strSql = strSql & "WHERE Code=" & CodePaEt
