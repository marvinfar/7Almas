...
Begin VB.Form FrmDetail7old 
   ...
   Begin HaftAlmas.TypeButton CmdClose 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmDetail7old.frx":0000
      PICN            =   "FrmDetail7old.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin HaftAlmas.TypeButton CmdSave 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmDetail7old.frx":3A8A
      PICN            =   "FrmDetail7old.frx":3AA6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Image ImgAlarm 
      Height          =   480
      Left            =   9120
      Picture         =   "FrmDetail7old.frx":707A
      Stretch         =   -1  'True
      Top             =   6000
      Width           =   480
   End
   ...
   Begin VB.Label Label2 
      ...
      Height          =   405
      Left            =   2460
      MouseIcon       =   "FrmDetail7old.frx":A1EE
   ...
   Begin VB.Label Label1 
      ...
      Height          =   405
      Left            =   5880
      MouseIcon       =   "FrmDetail7old.frx":A4F8
      MousePointer    =   99  'Custom
      RightToLeft     =   -1  'True
      TabIndex        =   22
      ToolTipText     =   "»« ò·Ìò „Ì  Ê«‰Ìœ ‘„«—Â Å—Ê«‰Â —« Ã” ÃÊ ò‰Ìœ"
   ...
   Begin VB.Label LblTitle 
      ...
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Å‰Ã—Â Ê—Êœ «ÿ·«⁄«  »—«Ì —œÌ› Â«Ì Õ„· —Ê“«‰Â"
      Height          =   405
      Left            =   990
   ...
   End
End
Attribute VB_Name = "FrmDetail7old"
...
Private Sub CmdSave_Click()
 ...
 strSql = strSql & "'" & TxtHavale & "','" & TxtKamioon & TxtSerial & "',"
 ...
 strSql = strSql & Val(CombMoshtariCode) & ",'" & TxtMomayez2 & "')"
 rs.Open strSql, CNS
 ''Kasr Az Kole PART
 Call KasrAzPART
 '
...
Private Sub CombParvane_Click()
 ...
 If rs.EOF Then
    MsgBox "‘„«—Â «⁄ »«— »—«Ì «Ì‰ Å—Ê«‰Â À»  ‰‘œÂ «” " & vbNewLine & _
           "»«Ìœ »Â »Œ‘  ⁄—Ì› Å«—  ÃœÌœ »—ê‘  ò‰Ìœ", vbExclamation, ""
 Else
    Do While Not rs.EOF
...
Private Function CheckValidate() As Boolean
 ...
 If Val(TxtPart) <= 0 Then
    MsgBox "Å«—  Ê«—œ ‘œÂ ‰«œ—”  «” ", vbExclamation, ""
    CheckValidate = False
    TxtPart.SetFocus
    Exit Function
 End If
