...
Begin VB.Form FrmMainFalle 
   ...
   Begin HaftAlmas.TypeButton CmdClose 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmMainFalle.frx":0000
      PICN            =   "FrmMainFalle.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin HaftAlmas.TypeButton CmdSave 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmMainFalle.frx":3A8A
      PICN            =   "FrmMainFalle.frx":3AA6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin VB.Label LblTitle 
      ...
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Å‰Ã—Â „⁄—›Ì Å—Ê«‰Â ›·Â ÃœÌœ («» œ«Ì ò«—- ﬁ»· «“ Ê—Êœ «ÿ·«⁄«  —Ê“«‰Â)"
      Height          =   405
      Left            =   1755
   ...
   End
End
Attribute VB_Name = "FrmMainFalle"
...
Private Sub CmdSave_Click()
 ...
 strSql = "SELECT Parvane,Etebar FROM MainFalle "
 ...
 Else
     rs.Close
     '
     Code = MakeAutoNumber("MainFalle", "Code")
     strSql = "INSERT INTO MainFalle "
...
Private Sub TxtParvane_LostFocus()
 If IF_ID_CHANGE Then  ' check code is duplicate or no
    ...
    rs.Open "SELECT Parvane,Etebar FROM MainFalle " & _
