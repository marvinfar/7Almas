...
Begin VB.Form FrmHavale7 
   ...
   Begin HaftAlmas.TypeButton CmdClose 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmHavale7Old.frx":0000
      PICN            =   "FrmHavale7Old.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin HaftAlmas.TypeButton CmdSave 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmHavale7Old.frx":3A8A
      PICN            =   "FrmHavale7Old.frx":3AA6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin HaftAlmas.TypeButton CmdDelete 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmHavale7Old.frx":707A
      PICN            =   "FrmHavale7Old.frx":7096
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin HaftAlmas.TypeButton CmdEdit 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmHavale7Old.frx":AC96
      PICN            =   "FrmHavale7Old.frx":ACB2
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin HaftAlmas.TypeButton CmdReportAddress 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmHavale7Old.frx":E3F6
      PICN            =   "FrmHavale7Old.frx":E412
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin HaftAlmas.TypeButton CmdTikAll 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmHavale7Old.frx":11D23
      PICN            =   "FrmHavale7Old.frx":11D3F
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin HaftAlmas.TypeButton CmdunTikALL 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmHavale7Old.frx":156CE
      PICN            =   "FrmHavale7Old.frx":156EA
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin HaftAlmas.TypeButton CmdFind 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmHavale7Old.frx":18DFC
      PICN            =   "FrmHavale7Old.frx":18E18
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin HaftAlmas.TypeButton CmdTafsili 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmHavale7Old.frx":1C717
      PICN            =   "FrmHavale7Old.frx":1C733
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
Private Sub CmdDelete_Click()
 ...
 If L > 0 Then
    ...
    If msg = vbYes Then
       ...
       strSql = "DELETE FROM Havale7 "
       strSql = strSql & "WHERE Havale='" & Grid1.Cell(L, 5).Text & "'"
       rs.Open strSql, CNS
       Grid1.RemoveItem L
...
Private Sub CmdEdit_Click()
 ...
 ElseIf CmdEdit.Caption = "À»   €ÌÌ—« " Then
    ...
    rs.Open strSql, CNS
ErrLbl:
    If Err.Number <> 0 Then MsgBox "„„Ì“ «‰»«—  ò—«—Ì „Ì »«‘œ", vbCritical, ""
...
Private Sub CmdFind_Click()
 If Grid1.Rows > 1 Then
    ...
    If b Then
       ...
       Grid1.SetFocus
    Else
       MsgBox "„„Ì“ «‰»«— „Ê—œ ‰Ÿ— ÅÌœ« ‰‘œ", vbInformation, ""
    End If
...
Private Sub CmdReportSelection_Click()
 ...
 Radif = 0
 kRow = 3
 FrmPreview.Grid1.OpenFile App.Path & "\RepHavaleTajamoEE.cel"
 ...
 For i = 1 To Grid1.Rows - 1
     If Grid1.Cell(i, 7).Text = "1" Then
        ...
        strSql = "SELECT Havale7.Havale,SUM(Vazn),SUM(Detail7.Tedad) "
        strSql = strSql & "FROM Havale7 INNER JOIN Detail7 ON "
        strSql = strSql & "Havale7.Havale = Detail7.Havale "
        strSql = strSql & "GROUP BY Havale7.Havale "
        strSql = strSql & "HAVING (((Havale7.Havale)='" & Havale & "'))"
        rs.Open strSql, CNS
...
Private Sub CmdSave_Click()
 ...
 If TxtHavale <> Empty Then
    ...
    Else
       rs.Close
       MsgBox "„„Ì“ «‰»«—  ò—«—Ì «” ", vbExclamation, ""
       TxtHavale.SetFocus
       SendKeys "{home}+{end}"
    End If
    Set rs = Nothing
 Else
    MsgBox "·ÿ›« „„Ì“ «‰»«— —« Ê«—œ ‰„«ÌÌœ", vbExclamation, ""
    TxtHavale.SetFocus
    SendKeys "{home}+{end}"
 End If
End Sub
...
Private Sub LoadHavale()
 ...
 strSql = strSql & "Moshtari.MoshtariCODE=Havale7.MoshtariCode )AS MC "
 strSql = strSql & "FROM Havale7 "
 rs.Open strSql, CNS
 r = 1
 Do While Not rs.EOF
...
Private Sub MakeHavaleAddress(Havale As String)
 ...
 If Not rs.EOF Then
    With FrmPreview.Grid1
        .OpenFile App.Path & "\RepHavaleTajamoEE.cel"
        i = 0
        Do While Not rs.EOF
